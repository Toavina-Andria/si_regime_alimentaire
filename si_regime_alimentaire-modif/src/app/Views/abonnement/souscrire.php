                ...
                <div class="col-md-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <strong>Prix:</strong>
                                <span class="h5 text-success"><?= number_format($abonnement['prix'] ?? 0, 2) ?>
                                    points</span>
                            </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <p class="mb-3">Vous avez déjà un abonnement actif. Vous ne pouvez souscrire à un autre
                                    abonnement que lorsque le vôtre aura expiré.</p>
                    ...
                    <div class="alert alert-info mt-4" role="alert">
                        ...
                        <small>
                            Cet abonnement vous permettra de bénéficier d'une réduction de
                            <?= $abonnement['taux_reduction'] ?? 0 ?>%
