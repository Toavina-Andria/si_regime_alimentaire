                            ...
                            <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                ...
                                                Réduction: <strong><?= $abonnement['taux_reduction'] ?? 0 ?>%</strong>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                Coût: <strong><?= number_format($abonnement['prix'] ?? 0, 2) ?> points</strong>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-footer bg-light">
                                    <?php if (!$activeSubscription): ?>
                                        <a href="<?= base_url('abonnement/' . $abonnement['id']) ?>" class="btn btn-primary w-100">
