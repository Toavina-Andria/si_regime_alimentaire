...
<head>
  ...
  <title>NutriPlan — Modifier le régime</title>
  ...
  <div class="main-content">
    ...
    <main class="page-content">
      <div class="page-header">
        <h1 class="page-title">Modifier le régime</h1>
        <p class="page-subtitle">Mettez à jour les informations de « <?= esc($regime['nom']) ?> »</p>
      </div>
      ...
      <div class="form-card">
        <form action="<?= base_url('regime/admin/update/' . $regime['id']) ?>" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-input" name="nom" value="<?= esc($regime['nom']) ?>" required>
          </div>

          <div class="form-group">
            <label class="form-label">Description</label>
            <textarea class="form-input" name="description" rows="4" style="resize:vertical;"><?= esc($regime['description']) ?></textarea>
          </div>

          <div class="form-row">
            <div class="form-group">
              <label class="form-label">% Viande</label>
              <input type="number" class="form-input" name="pct_viande" step="0.01" value="<?= $regime['pct_viande'] ?>" required>
            </div>
            <div class="form-group">
              <label class="form-label">% Volaille</label>
              <input type="number" class="form-input" name="pct_volaille" step="0.01" value="<?= $regime['pct_volaille'] ?>" required>
            </div>
            <div class="form-group">
              <label class="form-label">% Poisson</label>
              <input type="number" class="form-input" name="pct_poisson" step="0.01" value="<?= $regime['pct_poisson'] ?>" required>
            </div>
          </div>
          ...
          <div class="form-row-2">
            <div class="form-group">
              ...
              <input type="number" class="form-input" name="variation_poids_kg" step="0.1" value="<?= $regime['variation_poids_kg'] ?>" required>
            </div>
            <div class="form-group">
              <label class="form-label">Durée (jours)</label>
              <input type="number" class="form-input" name="duree_jours" min="1" value="<?= $regime['duree_jours'] ?>" required>
            </div>
          </div>
